...
__conda_setup="$('/Users/saybot/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/saybot/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/saybot/miniconda3/etc/profile.d/conda.sh"
    else
